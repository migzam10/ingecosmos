...
<a href="{{ route('catalogo-repuestos.create') }}" class="btn btn-primary">
    + Nuevo Repuesto
</a>
@endsection
...
<div class="card mb-3">
    <div class="card-body py-2">
        <form method="GET" action="{{ route('catalogo-repuestos.index') }}" class="row g-2 align-items-end">
            ...
            <tbody>
                ...
                <tr class="{{ !$item->activo ? 'opacity-50' : '' }}">
                    ...
                    <td class="text-end fw-bold">
                        $ {{ number_format($item->precio_referencia ?? 0, 0, ',', '.') }}
                    </td>
                    <td>
                        @if($item->activo)
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="{{ route('catalogo-repuestos.edit', $item) }}"
                ...
                <tr>
                    <td colspan="7" class="text-center text-muted py-4">
                        No hay repuestos en el catálogo con estos filtros.
                    </td>
                </tr>
                @endforelse
            </tbody>
